...
resource "aws_cognito_user_pool_client" "client" {
  ...
  callback_urls = ["https://${aws_amplify_branch.develop.branch_name}.${aws_amplify_app.sparky.default_domain}"]
  logout_urls   = ["https://${aws_amplify_branch.develop.branch_name}.${aws_amplify_app.sparky.default_domain}"]
